(function () {
...
})()(
  {
      ...
      function (require, module, exports) {
        ...
        (function (global) {
          ...
          function selectRecord(lastRecord, newRecord) {
            ...
            if (
              recordWithOldValue &&
              recordRepresentsCurrentMutation(lastRecord)
            )
              return recordWithOldValue;
            return null;
          }
        ...
        (function (scope) {
          ...
          var useNative = Boolean(
            IMPORT_LINK_TYPE in document.createElement("link")
          );
        ...
        window.HTMLImports.addModule(function (scope) {
          ...
          var importParser = {
            ...
            nextToParse: function () {
              ...
              return (
                !this.parsingElement &&
                (this.nextToParseInDoc(rootDocument) ||
            ...
            nextToParseInDoc: function (doc, link) {
              if (doc && this._mayParse.indexOf(doc) < 0) {
                ...
                var nodes = doc.querySelectorAll(
                  this.parseSelectorsForNode(doc)
                );
                for (
                  var i = 0, l = nodes.length, n;
                  i < l && (n = nodes[i]);
                  ...
                  if (!this.isParsed(n)) {
                    if (this.hasResource(n)) {
                      return nodeIsImport(n)
                        ? this.nextToParseInDoc(n.__doc, n)
                        : n;
                    } else {
                      return;
                    }
          ...
          function generateSourceMapHint(script) {
            ...
            var num = owner.__importedScripts
        ...
        window.HTMLImports.addModule(function (scope) {
            ...
            loaded: function (url, elt, resource, err, redirectedUrl) {
              ...
              if (isImportLink(elt)) {
                ...
                if (doc === undefined) {
                  doc = err
                    ? null
                    : makeDocument(resource, redirectedUrl || url);
                  if (doc) {
          ...
          function makeDocument(resource, url) {
            var doc =
              document.implementation.createHTMLDocument(IMPORT_LINK_TYPE);
            doc._URL = url;
        ...
        window.CustomElements.addModule(function (scope) {
          ...
          function _forDocumentTree(doc, cb, processingDocuments) {
            ...
            var imports = doc.querySelectorAll(
              "link[rel=" + IMPORT_LINK_TYPE + "]"
            );
            for (
              var i = 0, l = imports.length, n;
              i < l && (n = imports[i]);
              i++
            ) {
              if (n.import) {
        ...
        window.CustomElements.addModule(function (scope) {
          ...
          function inDocument(element) {
            ...
            while (p) {
              ...
              p =
                p.parentNode ||
                (p.nodeType === Node.DOCUMENT_FRAGMENT_NODE && p.host);
            }
          }
          function watchShadow(node) {
            if (node.shadowRoot && !node.shadowRoot.__watched) {
              flags.dom &&
                console.log("watching shadow-root for: ", node.localName);
              var root = node.shadowRoot;
              while (root) {
                observe(root);
                root = root.olderShadowRoot;
        ...
        window.CustomElements.addModule(function (scope) {
          ...
          function instantiate(definition) {
            return upgradeWithDefinition(
              domCreateElement(definition.tag),
              definition
            );
          }
          var registry = {};
    ...
    3: [
      function (require, module, exports) {
        ...
        ChromecastSessionManager = Class.extend(
          /** @lends ChromecastSessionManager.prototype **/ {
            ...
            init: function (player) {
              ...
              this.player.on(
                "dispose",
                this._removeCastContextEventListeners.bind(this)
              );

              this._notifyPlayerOfDevicesAvailabilityChange(
                this.getCastContext().getCastState()
              );
            ...
            _addCastContextEventListeners: function () {
              var sessionStateChangedEvt =
                  cast.framework.CastContextEventType.SESSION_STATE_CHANGED,
                castStateChangedEvt =
                  cast.framework.CastContextEventType.CAST_STATE_CHANGED;

              this.getCastContext().addEventListener(
                sessionStateChangedEvt,
            ...
            _removeCastContextEventListeners: function () {
              ...
              this.getCastContext().removeEventListener(
                sessionStateChangedEvt,
                this._sessionListener
              );
              this.getCastContext().removeEventListener(
            ...
            openCastMenu: function () {
              ...
              this.getCastContext()
                .requestSession()
                .then(onSessionSuccess, function () {
                  /* noop */
                });
            },
        ...
        ChromecastSessionManager.isChromecastConnected = function () {
          ...
          return (
            ChromecastSessionManager.isChromecastAPIAvailable() &&
            getCastContext().getCastState() ===
      ...
      function (require, module, exports) {
        ...
        ChromecastButton = {
          ...
          constructor: function (player) {
            ...
            player.on(
              "chromecastConnected",
              this._onChromecastConnected.bind(this)
            );
            player.on(
          ...
          _reloadCSSClasses: function () {
            ...
            console.log(this.buildCSSClass());
        ...
        module.exports = function (videojs) {
          ...
          ChromecastButtonImpl = videojs.extend(
    ...
    5: [
      function (require, module, exports) {
        ...
        function setUpChromecastButton(player, options) {
          ...
          if (
            options.addButtonToControlBar &&
            !player.controlBar.getChild("chromecastButton")
          ) {
          ...
          player.on(
            "chromecastRequested",
            onChromecastRequested.bind(null, player)
          );
        }
        ...
        function createSessionManager(player) {
          if (!player.chromecastSessionManager) {
            player.chromecastSessionManager = new ChromecastSessionManager(
              player
            );
          }
        }
        ...
        function waitUntilChromecastAPIsAreAvailable(player, options) {
          var maxTries =
              CHECK_AVAILABILITY_TIMEOUT / CHECK_AVAILABILITY_INTERVAL,
            tries = 1,
            intervalID;
      ...
      function (require, module, exports) {
        ...
        function doesUserAgentContainString(str) {
          return (
            ...
            window.navigator.userAgent.indexOf(str) >= 0
          );
        }
        ...
        module.exports = function () {
          ...
          androidChrome =
            doesUserAgentContainString("Android") &&
    ...
    9: [
      function (require, module, exports) {
        ...
        ChromecastTech = {
          ...
          constructor: function (options) {
            ...
            this._remotePlayer =
              this._chromecastSessionManager.getRemotePlayer();
        ...
        module.exports = function (videojs) {
          ...
          ChromecastTechImpl.canPlaySource =
            ChromecastSessionManager.isChromecastConnected.bind(
              ChromecastSessionManager
            );
      ...
      { "../chromecast/ChromecastSessionManager": 3, "./ChromecastTechUI": 10 },
    ],
    10: [
      function (require, module, exports) {
        "use strict";
        ...
        ChromecastTechUI = Class.extend(
          /** @lends ChromecastTechUI.prototype */ {
            init: function () {
            ...
            _createDOMElement: function () {
              var el = this._createElement(
                  "div",
                  "vjs-tech vjs-tech-chromecast"
                ),
                posterContainerEl = this._createElement(
                  "div",
                  "vjs-tech-chromecast-poster"
                ),
                posterImageEl = this._createElement(
                  "img",
                  "vjs-tech-chromecast-poster-img"
                ),
                titleEl = this._createElement(
                  "div",
                  "vjs-tech-chromecast-title"
                ),
                subtitleEl = this._createElement(
                  "div",
                  "vjs-tech-chromecast-subtitle"
                ),
                titleContainer = this._createElement(
                  "div",
            ...
            updatePoster: function (poster) {
              ...
              if (poster) {
                ...
                posterImageEl.classList.remove(
                  "vjs-tech-chromecast-poster-img-empty"
                );
              } else {
                posterImageEl.removeAttribute("src");
                posterImageEl.classList.add(
                  "vjs-tech-chromecast-poster-img-empty"
                );
              }
            },
