...
(function () {
...
})()(
  {
    ...
    5: [
      function (require, module, exports) {
        ...
        var ChromecastSessionManager = require("./chromecast/ChromecastSessionManager"),
          CHECK_AVAILABILITY_INTERVAL = 1e3,
          CHECK_AVAILABILITY_TIMEOUT = 30 * 1e3;
    ...
    9: [
      function (require, module, exports) {
        "use strict";
        var ChromecastSessionManager = require("../src/js/ChromecastSessionManager"),
          ChromecastTechUI = require("./ChromecastTechUI"),
          SESSION_TIMEOUT = 10 * 1e3,
          ChromecastTech;
        ChromecastTech = {
          constructor: function (options) {
            ...
            this._requestCustomData =
              options.requestCustomDataFn || function () {};
      ...
      {
        "../src/js/ChromecastSessionManager": 3,
        "./ChromecastTechUI": 10,
      },
    ],
    10: [
...
var cast_btn = document.getElementsByClassName("vjs-chromecast-button")[0];
console.log(cast_btn);
