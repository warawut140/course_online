...
@section('content')
    ...
    <div class="content">
        ...
        <!-- BEGIN: Wizard Layout -->
        <form method="POST" action="{{ url('admin/display_course/store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="intro-y box py-10 sm:py-15 mt-5">
                <div class="px-5 mt-0">
                    <div class="font-medium text-left text-lg">จัดการหลักสูตร</div>
                ...
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
                    <div class="font-medium text-base">ข้อมูลหลักสูตร</div>
                    <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                        <div class="intro-y col-span-12 sm:col-span-6">
                            <label for="input-wizard-1" class="form-label">ชื่อหลักสูตร</label>
                            <input id="input-wizard-1" name="name" type="text" class="form-control"
                                value="{{ @$data->name }}" readonly placeholder="กรุณาระบุข้อมูล">
                        </div>
                        ...
                        @if (@$data)
                            <div class="intro-y col-span-12 sm:col-span-12">
                                <img src="{{ asset('images/profile/' . @$data->image) }}" class="circleco mb-2 mw-100"
