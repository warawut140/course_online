                            ...
                            <tbody>
                                @foreach ($data_type as $key => $st)
                                    <tr>
                                        ...
                                        <td>{{ @$st->created_at }}</td>
                                        <td>
                                            <a href="{{url('admin/course_type/'.$st->id.'/view')}}" class="btn btn-sm btn-primary">จัดการ</a>
                                            <a href="{{url('admin/course_type/'.$st->id.'/delete')}}" class="btn btn-sm btn-danger" onclick="return confirm('ยืนยันการลบ?')">ลบข้อมูล</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
