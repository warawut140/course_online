        ...
        <div class="row mb-8">
            <div class="col-lg-12 mb-12 mb-lg-0 position-relative">
                    ...
                    <ul id="pills-tab" class="nav nav-pills course-tab-v2 h5 mb-0 flex-nowrap overflow-auto"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " id="pills-overview-tab2" data-bs-toggle="pill" href="#pills-overview2"
                                role="tab" aria-controls="pills-overview2" aria-selected="true">APPLICANT</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " id="pills-overview-tab3" data-bs-toggle="pill" href="#pills-overview3"
                                role="tab" aria-controls="pills-overview3" aria-selected="true">COURSE</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " id="pills-overview-tab4" data-bs-toggle="pill" href="#pills-overview4"
                                role="tab" aria-controls="pills-overview4"
                                aria-selected="true">แบบทดสอบ/WORKSHOP</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade " id="pills-overview2" role="tabpanel"
                        aria-labelledby="pills-overview-tab2">
                        @include('auth.profile.tab.company.applicant')
                    </div>

                    <div class="tab-pane fade " id="pills-overview3" role="tabpanel"
                        aria-labelledby="pills-overview-tab3">
                        @include('auth.profile.tab.company.course')
                    </div>

                    <div class="tab-pane fade " id="pills-overview4" role="tabpanel"
