...
<body>
    ...
    <div id="app" class="main">
        ...
        <br>
        @if (!$pro_quest_detail)
            <form method="POST" action="{{ url('workshop_inside_store') }}" id="searchForm"
        ...
        <div class="col-xl-12 offset-xl-12 col-lg-12 offset-lg-12 col-md-12 offset-md-12">
            ...
            <h4 style="color:#8B0900;"><i class="fa fa-file-text circlered " aria-hidden="true"
                    style="color:white;"></i>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12 ">
                                        <h5 style="color:gray;"> <input {{ $disable }} type="radio"
                                                id="html" <?php if (@$ans_data->option_id == $oq1->id) {
                                                    echo 'checked';
                                                } ?> required
                                                name="option_ans[{{ $quest->id }}]" value="{{ $oq1->id }}">
                                    ...
                                    <div class="form-group col-md-12 ">
                                        <h5 style="color:gray;"> <input {{ $disable }} type="radio"
                                                id="html" required <?php if (@$ans_data->option_id == $oq2->id) {
                                                    echo 'checked';
                                                } ?>
                                                name="option_ans[{{ $quest->id }}]" value="{{ $oq2->id }}">
                                    ...
                                    <div class="form-group col-md-12 ">
                                        <h5 style="color:gray;"> <input {{ $disable }} type="radio"
                                                id="html" required <?php if (@$ans_data->option_id == $oq3->id) {
                                                    echo 'checked';
                                                } ?>
                                                name="option_ans[{{ $quest->id }}]" value="{{ $oq3->id }}">
                                            <label for="html">{{ $oq3->name }}</label><br>
                                        </h5>
                                    </div>
                                    <div class="form-group col-md-12 ">
                                        <h5 style="color:gray;"> <input {{ $disable }} type="radio"
                                                id="html" required <?php if (@$ans_data->option_id == $oq4->id) {
                                                    echo 'checked';
                                                } ?>
                                                name="option_ans[{{ $quest->id }}]" value="{{ $oq4->id }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <input type="file" name="ans_file[{{ $quest->id }}]"
                                            class="form-control">
                                    </div>
                                    ...
                                    @if (@$type == 'check')
                                        <div class="form-group col-md-6 ">
                                            <select class="form-control" required
                                                ...
                                                <option @if (@$ans_data->pass == 1) selected @endif
                                                    value="1">ถูก</option>
                                                <option @if (@$ans_data->pass == 2) selected @endif
                                                    value="2">ผิด</option>
                                            </select>
                                        </div>
                                    @endif
            ...
            @if (@$type == 'check')
                <div class="form-group">
                    <button type="submit" {{ $disable }} class="btn btn-outline-primary w-100"
