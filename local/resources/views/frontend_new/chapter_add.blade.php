                                ...
                                <form method="POST" action="{{ url('chapter_store') }}" id="searchForm"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" class="form-control placeholder-1" id="order"
                                                value="{{ @$data->order }}" name="order">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="name">ชื่อบทเรียน</label>
                                            <input type="text" class="form-control placeholder-1" id="name"
                                                value="{{ @$data->name }}" name="name">
                                        </div>

                                        <div class="col-md-3">
                                            <label for="">วิดิโอ (จำนวน)</label>
                                            <input type="number" class="form-control placeholder-1" id=""
                                        ...
                                        <div class="items">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <button class="btn btn-sm btn-danger remove_video" type="button"
                                                        title="ลบวิดิโอ"
                                                        onclick="return confirm('ยืนยันการลบวิดิโอ?')">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control course_free" required
                                                        name="course_free">
