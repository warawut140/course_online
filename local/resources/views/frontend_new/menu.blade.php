         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <div class="d-md-flex justify-content-between">
                     <a href="#" class="d-block d-md-inline-block mb-4 mb-md-0 btn btn-primary btn-sm-wide">VIEW
                         CART</a>
                     <a href="#"
     ...
     <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
             ...
             <ul class="navbar-nav ms-auto">
                 ...
                 <li class="nav-item dropdown dropdown-full-width">
                     <a class="nav-link" href="{{ url('worklist') }}">
                         การรับสมัครงาน
                     </a>
                 </li>
                 ...
                 @if (Auth::guest())
                     ...
                     <li class="nav-item dropdown dropdown-full-width">
                         <a class="nav-link" href="{{ url('login') }}">
                             <font style="color:red"> เข้าสู่ระบบ</font>
                         </a>
                     </li>
                 @else
                         ...
                         <div class="dropdown-menu border-xl shadow-none dropdown-menu-md"
                             ...
                             <div class="list-group list-group-flush">
                                 @if (Auth::user()->profile->type_user_id == 1)
                                     <a class="list-group-item" href="{{ url('profile_student') }}">
                                         <!-- Icon -->
                                 ...
                                 @elseif(Auth::user()->profile->type_user_id_2 == 2)
                                     <a class="list-group-item" href="{{ url('profile_company') }}">
                                         <!-- Icon -->
                                         <div class="display-4 text-primary">
                                             <i class="fas fa-clipboard"></i>
                                         </div>
                                 ...
                                 <a class="list-group-item" href="{{ url('profile') }}">
                                     ...
                                     <div class="ms-4">
                                         ...
                                         <!-- Text -->
                                         <p class="font-size-sm text-gray-700 mb-0">
                                             แก้ไขข้อมูลและเพิ่มข้อมูลต่างๆ
                                         </p>
                                     </div>
                                 </a>
