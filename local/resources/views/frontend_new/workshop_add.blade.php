                                ...
                                <form method="POST" action="{{ url('workshop_store') }}" id="searchForm"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control placeholder-1" required name="type">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" required class="form-control placeholder-1" required
                                                value="{{ @$data->name }}" id="name" name="name">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="course_list_id">เรื่องที่เรียน</label>
                                            <select class="form-control placeholder-1" required name="course_list_id">
                                                <option value="">กรุณาเลือก</option>
                                                @foreach ($list as $l)
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control time_test" required
                                                name="time_test" value="{{ @$data->time_test }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" class="form-control placeholder-1 detail_ck" name="details">{{ @$data->details }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" required class="form-control placeholder-1"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control placeholder-1" required
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-outline-primary w-100">บันทึก</button>
                                        </div>
                                    </div>
