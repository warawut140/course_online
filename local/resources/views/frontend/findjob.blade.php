    ...
    <div class="bgdd">
        ...
        <div class="main opcenter">
            ...
            <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="opcenter">
                                ...
                                <h5 class="mb-3 text-left">
                                    <font style="color:grey">รายการแนะนำ</font>
                                </h5>
                                <br>
                ...
                <a class="nav-link py-1 buttonblack"   style="margin-right: 20px;margin-top: 20px;"href="javascript:;"><font style="color:grey">การตลาด</font></a>
                <a class="nav-link py-1 buttonblack"   style="margin-right: 20px;margin-top: 20px;"href="javascript:;"><font style="color:grey">นักวิชาการ</font></a>
                <a class="nav-link py-1 buttonblack"   style="margin-right: 20px;margin-top: 20px;"href="javascript:;"><font style="color:grey">นักบัญชี</font></a>  --}}
                                </div></span></p>
                                <div class="left">
                            ...
                            <div class="right">
                                <a href="{{ url('register_user_detail') }}" style="background-color: #8B0900; color:white;"
                                    class="btn ">ถัดไป <i class="fa fa-chevron-right" aria-hidden="true"></i> </a>
