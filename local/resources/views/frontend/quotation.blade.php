...
{{--                            <button class="btn btn-light w-100 mb-2"><i class='fas fa-bookmark'></i> ติดตาม   </button>--}}
        ...
        @if($type == 'install_machine')
            {{--<install-machine :profile_id="{{ $profile->id }}" :project_auctions_id="{{ $id }}"></install-machine>--}}
            <install-machine :profile_id="{{ $profile->id }}"
                             :project_auctions_id="{{ $id }}"
        ...
        @elseif($type == 'control')
            ...
            ></control>
        @elseif($type == 'main')
            <main-air  :profile_id="{{ $profile->id }}"
                       :project_auctions_id="{{ $id }}"
                       :image="'{{ $profile->image_profile }}'"
                       :firstname="'{{ $profile->firstname }}'"
                       :lastname="'{{ $profile->lastname }}'"
                       :user_id="'{{ $profile->user_id }}'"
            ></main-air>
        @elseif($type == 'duct_piping')
            <duct-piping  :profile_id="{{ $profile->id }}"
                          :project_auctions_id="{{ $id }}"
                          :image="'{{ $profile->image_profile }}'"
                          :firstname="'{{ $profile->firstname }}'"
                          :lastname="'{{ $profile->lastname }}'"
