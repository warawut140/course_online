              ...
              <div class="border shadow rounded p-6 p-md-9">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-12">
                          ...
                          <input name="academy" type="text" value="{{ @$education->academy }}"
                  ...
                  <div class="form-row">
                      <div class="form-group">
                          ...
                          <input name="level" type="text" value="{{ @$education->level }}"
                              class="form-control placeholder-1">
                      </div>
                      <div class="form-group">
                  ...
                  <div class="form-row">
                      <div class="form-group">
                          ...
                          <input name="date_start" type="date" value="{{ @$education->date_start }}"
                              class="form-control placeholder-1" id="date_start">
                      </div>
                      <div class="form-group">
                          <label for="date_end">วันสิ้นสุด</label>
                          <input name="date_end" type="date" value="{{ @$education->date_end }}"
                              class="form-control placeholder-1">
                      </div>
                  </div>
                  <div class="form-row">
                      <div class="form-group">
                          ...
                          <input name="grade" type="text" value="{{ @$education->grade }}"
                              class="form-control placeholder-1">
                      </div>
                      <div class="form-group">
