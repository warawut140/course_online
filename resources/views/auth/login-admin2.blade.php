                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                            Welcome to
                            Online education & job
                            <br>
                            sign in to your account.
                        </div>
                        <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Admin Manage
                        </div>
                    </div>
                </div>
                <!-- END: Login Info -->
                    ...
                    <div
                        ...
                        <div class="intro-x mt-8">
                            ...
                            <input type="password" name="password" id="password"
                                class="intro-x login__input form-control py-3 px-4 block {{ $errors->has('password') ? ' is-invalid' : '' }}"
