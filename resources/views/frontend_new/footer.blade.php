    ...
    <div class="container">
        <div class="row" id="accordionFooter">
            <div class="col-12 col-md-4 col-lg-4">
                ...
                <div class="mb-4">
                    <a href="tel:1234567890" class="text-white-800 font-size-sm-alone">0989307068</a>
                </div>

                <div class="mb-4">
                    <a href="mailto:support@skola.com" class="text-white-800 font-size-sm-alone">support@eduflix.com</a>
                </div>
            ...
            {{-- <div class="col-12 col-md-4 col-lg-2">
                    <div class="mb-5 mb-xl-0 footer-accordion">
                        ...
                        <div id="widgetcollapseOne" class="collapse show" aria-labelledby="widgetOne"
                            ...
                            <!-- List -->
                            <ul class="list-unstyled text-white-800 font-size-sm-alone mb-6 mb-md-8 mb-lg-0">
                                <li class="mb-3">
                ...
                <div class="col-12 col-md-4 offset-md-4 col-lg-2 offset-lg-0">
                    <div class="mb-5 mb-xl-0 ms-xl-6 footer-accordion">
                        ...
                        <div id="widgetcollapseThree" class="collapse" aria-labelledby="widgetThree"
                            data-parent="#accordionFooter">
                            <!-- List -->
                            <ul class="list-unstyled text-white-800 font-size-sm-alone mb-0">
                                <li class="mb-3">
                    ...
                    <div
                        ...
                        {{-- <ul
                                ...
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./index.html" class="nav-link px-4 fw-normal text-white-800">Home</a>
                                </li>
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                        class="nav-link px-4 fw-normal text-white-800">Site Map</a>
                                </li>
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                        class="nav-link px-4 fw-normal text-white-800">Privacy policy</a>
                                </li>
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                        class="nav-link px-4 fw-normal text-white-800">Web Use Policy</a>
                                </li>
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                        class="nav-link px-4 fw-normal text-white-800">Cookie Policy</a>
                                </li>
                            </ul> --}}
