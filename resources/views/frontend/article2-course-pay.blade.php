            ...
            <div id="content">
                ...
                <div class="text-center py-5">
                    <span class="fa-stack fa-5x">
                      ...
                      <i class="fas fa-coins fa-stack-1x text-black"></i>
                    </span>
                    <h3 class="my-4">กรุณาทำการชำระเงินเพื่อดูวิดีโอนี้</h3>
                    <button class="btn btn-warning rounded-0 mb-5" >ชำระเงิน</button>
                </div>
