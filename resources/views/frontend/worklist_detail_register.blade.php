                    ...
                    <div class="col-12">{{-- start #work --}}
                        <div class="row">
                            <div class="col-4">
                                ...
                                <img src="{{ asset('images/profile/' . $profile->image_profile) }}" class="mw-100 mb-3"
                                    width="150px" height="150px">
                            </div>
                            <div class="col-8">
                                <h6 class="mb-3 text-left">
                                    <font style="color:rgb(206, 21, 21)">{{ $profile->firstname }}
                                        {{ $profile->lastname }}</font>
                                </h6>
                                <p class="mb-3 text-left">
                                    <font style="color:gray">{{ $profile->company_address }}</font>
                                </p>
                                <p class="mb-3 text-left">
                                    <font style="color:gray">{{ $profile->title_about_me }}</font>
                                </p>
                                {{-- <p class="mb-3 text-left">
                                    <font style="color:gray"><i class="fa fa-clock" aria-hidden="true"
                                            style="color:green;"></i> {{ $j->created_at }} </font>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group text-left">
                                    <label style="color:rgb(49, 49, 49)">E-mail</label>
                                    <input type="text" class="form-control" required id="email"
                                        value="" name="email" placeholder="กรุณาระบุ">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group text-left">
                                    <label style="color:rgb(49, 49, 49)">โทรศัพท์</label>
                                    <input type="text" class="form-control" required id="tel"
                                        value="" name="tel" placeholder="กรุณาระบุ">
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="form-group text-left">
                                    <label style="color:rgb(49, 49, 49)">Resume</label>
                                    <input type="file" class="form-control" required id="resume"
                                        value="" name="resume" placeholder="กรุณาระบุ">
                                </div>
                            </div>
