...
@section('content')
    ...
    <div class="content">
        ...
        <div id="icon-alert" class="p-5">
            <div class="preview">
                <div class="alert alert-success show flex items-center mb-2 success" style="color:white;" role="alert"> <i data-lucide="alert-triangle"
        ...
        <div id="icon-alert" class="p-5">
            <div class="preview">
                <div class="alert alert-danger show flex items-center mb-2 error" style="color:white;" role="alert"> <i data-lucide="alert-triangle"
                        class="w-6 h-6 mr-2"></i> {{@session('error')}} </div>
            </div>
        </div>
        @endif
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                <a href="{{ url('admin/work_type/add') }}" class="btn btn-primary shadow-md mr-2"><span
                            ...
                            <tbody>
                                @foreach ($data_type as $key => $st)
                                    <tr>
                                        ...
                                        <td>{{ @$st->created_at }}</td>
                                        <td>
                                            <a href="{{url('admin/work_type/'.$st->id.'/view')}}" class="btn btn-sm btn-primary">จัดการ</a>
                                            <a href="{{url('admin/work_type/'.$st->id.'/delete')}}" class="btn btn-sm btn-danger" onclick="return confirm('ยืนยันการลบ?')">ลบข้อมูล</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
